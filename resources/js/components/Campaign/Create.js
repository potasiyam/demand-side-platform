...
class Create extends Component {
    ...
    createCampaign = (event) => {
        ...
        axios.post('/api/campaign/create', formData, config)
            .then(res => {
                window.location = '/'
            })
            .catch(err => {
            ...
            <div>
                ...
                <form onSubmit={this.createCampaign}>
                    ...
                    <div className="form-group">
                        ...
                        <input type="date" name="start_date" onChange={this.handleChange} className="form-control"
                               required/>
                    </div>
                    <div className="form-group">
                        <label htmlFor="exampleInputEmail1">End Date</label>
                        <input type="date" name="end_date" onChange={this.handleChange} className="form-control"
                               required/>
                    </div>
                    <div className="form-group">
